...
public class BankAccount {
	...
	public void deposit(long l) throws BankAccountException {
		if(l<0) {
			throw new BankAccountException("마이너스 입금은 불가능합니다.",1000 );
	...
	public long withdraw(long i) throws BankAccountException{
		if(i<0) {
			throw new BankAccountException("마이너스 출금은 불가능합니다.", 2000);
	...
	public void transfer(BankAccount you, long i) throws BankAccountException {

		you.deposit(withdraw(i)); //처리를 무조건 할필요는 없음
